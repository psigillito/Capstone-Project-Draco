      ...
      return(
        <div>
          ...
          <div class="modal-body ">
            ...
            {this.state.mode === '' && 
                <div class="alert alert-primary" role="alert">You must select a workout mode to add exercises!</div>
            }
            ...
            {this.state.mode === 'Weight Training' && this.state.mode != '' &&
              <div>
                ...
                <br/>
                <div>
                  <button type="button" onClick={() => this.saveExercise()} class="btn btn-primary btn-block">Add Exercise To Workout</button>
                </div>
              </div>
            }
